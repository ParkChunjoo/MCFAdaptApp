    ...
    public class SelectPatientViewModel : INotifyPropertyChanged
    {
        ...
        public string StatusMessage
        {
            ...
            set
            {
                ...
                OnPropertyChanged();
                Console.WriteLine($"[{DateTime.Now:HH:mm:ss.fff}] Status message changed: {value}");
            }
        }
        ...
        private async Task SelectAsReferencePlanAsync()
        {
            ...
            try
            {
                ...
                StatusMessage = "Loading CBCT Projections";
                Console.WriteLine($"[{DateTime.Now:HH:mm:ss.fff}] Loading CBCT Projections for patient: {SelectedPatient.PatientId}");
                await Task.Delay(2000); // Wait for 2 seconds

                StatusMessage = "Loading Reference Plan";
                Console.WriteLine($"[{DateTime.Now:HH:mm:ss.fff}] Loading Reference Plan for patient: {SelectedPatient.PatientId}");
                await Task.Delay(2000); // Wait for 2 seconds
